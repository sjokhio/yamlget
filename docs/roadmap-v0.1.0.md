...
|------|----------|-----------|
| 0 | `YAMLGET_EXIT_OK` | Key found, value printed |
...
- [x] Block scalars (`|` and `>`) - completed in M4
...
- [x] Integration test suite expanded from 61 to 102 tests (112 total with lexer)
...
### M5: Integration and polish (done)
...
- [x] GitHub Actions release workflow (`.github/workflows/release.yml`)
  for Linux x86_64, macOS x86_64, macOS arm64, Windows x86_64 binaries
...
These are excluded and will not be considered for v0.1.0 even if a patch is submitted:
